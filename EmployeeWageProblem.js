...
//UC3
//Refactor the code to get Employee Working Hour
/*
const IS_PART_TIME = 1;
const IS_FULL_TIME = 2;
const PART_TIME_HOURS = 4;
...
//UC5
//Calculate Employee Wage till contion of 160 hours or 20 Days
/*
const IS_PART_TIME = 1;
const IS_FULL_TIME = 2;
const PART_TIME_HOURS = 4;
...
//Creating Employee Payroll Class
/*
...
let employeeObject = new EmployeePayRollData(1,'Prateek',200000);
...
let employeeObject = new EmployeePayRollData(1,'Prateek',200000);
console.log(employeeObject.toString());
let newEmployeeObject = new EmployeePayRollData(2,'Ramanath',200000,'M',new Date());
...
console.log(employeeObject.toString());
try{
    let newEmployeeObject = new EmployeePayRollData(2,'vasanth',200000,'M',new Date());
    console.log(newEmployeeObject.toString());
}
catch(ex){
    console.error(ex);
...
let employeeObject1 = new EmployeePayRollData(1,'Prateek',200000,'M',new Date());
console.log(employeeObject1.toString());
try{
    let employeeObject = new EmployeePayRollData(2,'Ramanath',200000,'S',new Date());
    console.log(employeeObject.toString());
}
catch (ex){
    console.error(ex);
    ...
    try{
        let newEmployeeObject = new EmployeePayRollData(3,'Vasanth',200000,'F',new Date(2022,3,7,12,12,12,12));
        console.log(newEmployeeObject.toString());
    }
    catch (ex){
        console.error(ex);
